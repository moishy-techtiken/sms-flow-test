...
exports.flow = {
    ...
    steps: {
        ...
        chooseLocation: {
            type: "choice",
            messageTemplate: "{{appointmentLocationPromptText}}\n{{appointmentLocationOptionsText}}",
        ...
        chooseTime: {
            type: "choice",
            messageTemplate: "{{appointmentTimePromptText}}\n{{appointmentTimeOptionsText}}",
        ...
        noLocationsAvailable: {
            type: "end",
            message: "There are no booking locations open right now. Please try again later."
        },
        noDaysAvailable: {
            type: "end",
            messageTemplate: "There are no available days for {{selectedLocationName}} right now. Please try again later."
        },
        bookingSuccess: {
            type: "end",
            messageTemplate: "Your appointment is booked.\nLocation: {{selectedLocationName}}\nPeople: {{appointmentCount}}\nDay: {{selectedDate}}\nTime: {{selectedDisplayTime}}"
        },
        bookingError: {
            type: "end",
            message: "We could not complete your booking right now. Please try again later."
        }
    }
};
