...
exports.flow = {
    ...
    steps: {
        welcome: {
            type: "message",
            message: "Thank you for donating to Reb Meir. Reply with the donation amount.",
            next: "getAmount"
        },
        getAmount: {
            type: "input",
        ...
        confirmDonation: {
            type: "choice",
            messageTemplate: "You are donating ${{donationAmount}} under {{donorName}}. Reply 1 to confirm or 2 to start over.",
        ...
        donationFailed: {
            type: "end",
            message: "We could not save the donation right now. Please try again later."
        },
        done: {
            type: "end",
            messageTemplate: "Thank you. Your donation of ${{donationAmount}} for {{donorName}} was recorded."
        }
    }
};
